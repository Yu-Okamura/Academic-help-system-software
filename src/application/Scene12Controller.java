...
public class Scene12Controller {
    ...
    private void handleSignIn(ActionEvent event) {
    	String selected_role = roleChoiceBox.getValue();
        System.out.println("Role selected: " + selected_role);
        
        if(selected_role == "Administrator") {
        	passedUser.current_role = 1;
        	this.roleid = 1;
        }
        else if(selected_role == "Student") {
        	passedUser.current_role = 2;
        	this.roleid = 2;
        }
        else if(selected_role == "Instructor") {
        	passedUser.current_role = 3;
        	this.roleid = 3;
        }
        ...
        //4,5,7
        if (passedUser.current_role == 2 || passedUser.current_role == 3) {
