...
//    );
    ...
    public void loadArticleData(ActionEvent event, int groupID) {
	...
	//If we want to load all articles
        if (groupID == 0) {
            ...
            if(admin.validateUserGroup(admin.getUserID(passedUser), groupID) == -1) {
            	System.out.println("Error: user is not in the proper group.");
